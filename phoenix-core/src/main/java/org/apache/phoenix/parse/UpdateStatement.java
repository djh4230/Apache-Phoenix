...
public class UpdateStatement extends DMLStatement {
    ...
    public UpdateStatement(NamedTableNode table, HintNode hint, List<ColumnName> columns,
                           List<ParseNode> values, ParseNode where,SelectStatement select, int bindCount,
